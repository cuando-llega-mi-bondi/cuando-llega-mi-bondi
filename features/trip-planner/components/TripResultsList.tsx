...
/*
 * Contenido de resultados del planificador, compartido entre el bottom-sheet
 * (mobile, TripResultsSheet) y el panel docked (desktop, ComoLlegoClient).
 */
...
/** Fila "N opciones de viaje + Nuevo viaje" (header del sheet / top del panel). */
export function TripResultsHeader({
    count,
    onNewTrip,
}: {
    count: number;
    ...
    return (
        <div className="mb-3 flex items-center justify-between gap-3 px-1">
            <span className="text-base font-bold text-foreground">
                {count} {count === 1 ? "opción de viaje" : "opciones de viaje"}
            </span>
            <button
                type="button"
...
export type TripResultsListProps = {
...
/** Aviso 221 + cards de itinerarios (con timeline expandible) + caption. */
